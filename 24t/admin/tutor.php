<?php 
 ...
 if (isset($_GET['show']) && ctype_digit($_GET['show'])){
    ...
    if ($_GET['show'] === "1"){
        $Q = "SELECT * FROM `tutor` WHERE `tutor_id` = :value1 ";
        $Ehhco = '<center><label>Search by ID</label></center><form action="tutor.php?show=1" method="post">'.$default;
    }elseif ($_GET['show'] === "2"){
        $Q = "SELECT * FROM `tutor` WHERE `t_fname` =:value1  AND `t_lname` =:value2 ";
        $Ehhco = '<center><label>Search by Name</label></center><form action="tutor.php?show=2" method="post">
        <div class="panel-body">
            <div class="table-responsive">
            <div class="col-md-3">  
        ...
        $Q = "SELECT * FROM `tutor` WHERE `t_usrn` = :value1  ";
        $Ehhco = '<center><label>Search by Username</label></center><form action="tutor.php?show=3" method="post">'.$default;
    }elseif ($_GET['show'] === "4"){
        $Q = "SELECT * FROM `tutor` WHERE `t_email` = :value1 ";
        $Ehhco = '<center><label>Search by Email</label></center><form action="tutor.php?show=4" method="post">'.$default;
    }
    else{
        $Q = "SELECT * FROM `tutor` ";
        $Ehhco = "";
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
			 <div class="row">
                ...
                <div class="btn-group">
                    <button class="button" onclick="window.location.href='tutor.php'">Show All</button>
                    <button class="button" onclick="window.location.href='tutor.php?show=1'">Search By ID</button>
                    <button class="button" onclick="window.location.href='tutor.php?show=2'">Search By FirstLastName</button>
                    <button class="button" onclick="window.location.href='tutor.php?show=3'">Search By Username</button>
                    <button class="button" onclick="window.location.href='tutor.php?show=4'">Search By Email</button>
                </div>
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <span class="fa fa-bell"> <strong>Basic Tutor Info</strong></span>
                            </div> 
        ...
        <?php
                                    ...
                                    <td><b><a href='viewprofile.php?tutor=".$row['tutor_id']."' button type='button' class='btn btn-primary'>".$row['tutor_id']."</a></b></td> 
                                        ...
                                        <td><b>".$row['t_email']."</b></td>
                                        <td><b>".$row['t_usrn']."</b></td>
                                        <td><b>".$row['t_active']."</b></td>
                                        <td><img src='$picture' class='thumbnail' height='50' width='50' /></td>    
                                        <td><b>".$row['t_gender']."</b></td> 
                                        <td><b>".$bool."</b></td>
                                        <td><b>".$row['t_registerdate']."</b></td> 
                                   </tr>" ; 
                                   }
                                    }else{
                                    echo '
